...
class register_ui extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    _register(){
      var register_event = _register_event(email, ph_no,userName, pool, password);
    }
  ...
  Future<bool> _register_event(String email, String ph_no , String name, bool pool, String pass) async{
...
class register{
  Firestore db = Firestore.instance;
  Future<bool> register_event(String email, String ph_no , String name, bool pool, String pass) async{
    TransactionHandler createTransaction = (Transaction tx ) async{
      DocumentSnapshot ds = await tx.get(db.collection('users').document(email));
      var dataMap =new Map<String, String>();
      dataMap['name']= name;
